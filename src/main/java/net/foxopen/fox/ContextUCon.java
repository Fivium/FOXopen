 ...
 * over the transactional integrity of their modules while minimising excessive connection usage.<br/><br/>
 *
...
public class ContextUCon implements FxpContextUCon<UCon> {
  ...
  public static ContextUCon createContextUCon(String pPoolName, String pContextUConPurpose) {
    return new ContextUCon(pPoolName, pContextUConPurpose);
  }
  ...
  public void rollbackCurrentConnection() {
    ...
    if(isTransactionControlAllowed()) {
      ...
      throw new ExInternal("Programmatic rollback not allowed for connection " + lTopConnection.mConnectionName);
    }
  }
}

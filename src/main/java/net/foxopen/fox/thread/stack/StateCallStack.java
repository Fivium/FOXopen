...
implements ListeningPersistable {
   ...
   * @return All Persistables implicated in a delete of this StateCallStack.
   */
  Collection<PersistenceResult> allImplicatedByDelete(){
    ...
    //Mark both individual calls and the stack as deleted (to prevent unnecessary updates on the deleted calls)

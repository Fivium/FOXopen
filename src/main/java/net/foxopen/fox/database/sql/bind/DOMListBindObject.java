...
implements CloseableBindObject {
  ...
  public static class Builder extends BindObjectBuilder<DOMListBindObject> {

    private final DOMList mBindDOMList;

    public Builder(DOMList pBindDOMList, BindDirection pBindDirection) {
      super(pBindDirection);
      mBindDOMList = pBindDOMList;
    }

    @Override
    public DOMListBindObject build() {
      return new DOMListBindObject(mBindDOMList, getBindDirection());
    }
  }
}

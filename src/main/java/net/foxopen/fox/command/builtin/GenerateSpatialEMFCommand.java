...
// TODO - NP - carto - Reimplement this command when needed
public class GenerateSpatialEMFCommand extends BuiltInCommand {
  ...
  public GenerateSpatialEMFCommand(DOM pCommandDOM) {
    super(pCommandDOM);
    throw new ExInternal("GenerateSpatialEMFCommand needs re-implementing");
//
...
//    SpatialEngine lSpatialEngine = null; //TODO PN pXThread.getTopApp().getSpatialEngineOrNull();
...
//    lSpatialBootstrapDOM = null;//lSpatialEngine.bootstrapSpatialCanvas(lSpatialBootstrapDOM, pRequestContext.getCurrentCallId(), pRequestContext.getAuthenticationContext().getAuthenticatedUser().getAccountID(), lUCon);
//

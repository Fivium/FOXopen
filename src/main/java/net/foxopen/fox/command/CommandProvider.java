...
import net.foxopen.fox.command.builtin.GetCookieCommand;
...
import net.foxopen.fox.command.builtin.SetCookieCommand;
...
public class CommandProvider {
  ...
  */
  private CommandProvider() {
    ...
    registerCommandFactory(new GetCookieCommand.Factory());
    ...
    registerCommandFactory(new SetCookieCommand.Factory());

...
public enum NodeAttribute {
  ...
  FORM_LIST("formList", ValueType.EVALUATABLE_XPATH, ResultType.BOOLEAN),
  ...
  SEARCH_CLEAR_FILTER_ON_BLUR("searchClearFilterOnBlur", ValueType.EVALUATABLE_XPATH, ResultType.BOOLEAN),
  ...
  SEARCH_FREE_TEXT_INPUT("searchFreeTextInput", ValueType.EVALUATABLE_XPATH, ResultType.BOOLEAN),
  SEARCH_FREE_TEXT_INPUT_MESSAGE("searchFreeTextInputMessage", ValueType.EVALUATABLE_XPATH, ResultType.STRING),
  SEARCH_FREE_TEXT_SUGGEST("searchFreeTextSuggest", ValueType.EVALUATABLE_XPATH, ResultType.BOOLEAN),
